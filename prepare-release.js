...
changelog = changelog.replace(/\[Unreleased\]\:.*v(.*)\.\.\.master/, `[Unreleased]: https://github.com/smartive/giuseppe/compare/v${versionNumber}...master
[${versionNumber}]: https://github.com/smartive/giuseppe/compare/v$1...v${versionNumber}`);
